...
import { useDeleteBed } from '@/api/hooks/useBeds'
...
export function DataTableRowActions<TData extends { id: string }>({
  ...
  const { mutateAsync: deleteBedById, isPending: isDeleting } = useDeleteBed()
  ...
  const handleEditClick = () => {
    navigate({
      to: `/dashboard/beds/${row.original.id}/edit`,
    })
  }
  const handleViewClick = () => {
    navigate({
      to: `/dashboard/beds/${row.original.id}`,
    })
  }
