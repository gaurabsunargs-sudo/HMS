...
import { useDeleteBill } from '@/api/hooks/useBills'
...
export function DataTableRowActions<TData extends { id: string }>({
  ...
  const { mutateAsync: deleteBillById, isPending: isDeleting } = useDeleteBill()
  ...
  const handleEditClick = () => {
    navigate({
      to: `/dashboard/bills/${row.original.id}/edit`,
    })
  }
  const handleViewClick = () => {
    navigate({
      to: `/dashboard/bills/${row.original.id}`,
    })
  }
