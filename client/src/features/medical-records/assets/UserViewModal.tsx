  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className='max-w-lg'>
        <DialogHeader>
          <DialogTitle>MedicalRecord Details</DialogTitle>
          <DialogDescription>
            <div className='space-y-2'>
              ...
              <div>
                ...
                {medicalRecord.email_verified_at ? (
              ...
              <div>
                ...
                <div className='mt-1 flex flex-wrap gap-1'>
                  {medicalRecord.roles && medicalRecord.roles.length > 0 ? (
                    medicalRecord.roles.map((role) => (
