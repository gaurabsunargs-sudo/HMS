...
export function DataTableRowActions<TData extends { id: string }>({
  ...
  const handleEditClick = () => {
    navigate({
      to: `/dashboard/medical-records/${row.original.id}/edit`,
    })
  }
  const handleViewClick = () => {
    navigate({
      to: `/dashboard/medical-records/${row.original.id}`,
    })
  }
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      setIsLoading(true)
      await deleteMedicalRecordById(deleteId)
  ...
  return (
    <>
      ...
      <DeleteConfirmation
        ...
        title='Delete medicalRecord'
        description='Are you sure you want to delete this medicalRecord? This action cannot be undone.'
      />
    </>
  )
}
