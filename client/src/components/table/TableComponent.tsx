            ...
            <TableBody>
              {loading ? (
                ...
                <>
                  ...
                  {showTotal && (
                    <TableRow className="border-t hidden font-medium">
                      <TableCell
                        colSpan={3}
                        className="font-medium text-end"
                      ></TableCell>
                      <TableCell className="w-[100px] text-end"></TableCell>
                      <TableCell className="w-[100px] text-end"></TableCell>
                      <TableCell className="w-[100px] text-end"></TableCell>
                      <TableCell className="w-[100px] text-end"></TableCell>
                      <TableCell className="w-[40px] text-end"></TableCell>
                    </TableRow>
                  )}
                </>
              ) : (
